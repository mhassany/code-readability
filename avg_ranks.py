...
# Rank - Cyclomatic Complexity By File	
cc = [
    [1, "flask/app.py"],
    [2, "flask/cli.py"],
    [3, "flask/ctx.py"],
...
# Rank - Maintainability Index By File	
mi = [
    [1, "flask/app.py"],
    [2, "flask/cli.py"],
    [3, "flask/helpers.py"],
...
# Rank - Line Addition/Removal by File	
ar = [
    [1, "flask/app.py"],
    [2, "flask/cli.py"],
    [3, "flask/helpers.py"],
